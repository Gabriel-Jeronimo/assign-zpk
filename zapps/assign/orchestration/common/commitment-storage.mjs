...
export async function joinCommitments(
	...
	const oldCommitment_0_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(oldCommitment_0_nullifier);
	const oldCommitment_1_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(oldCommitment_1_nullifier);
	...
	const oldCommitment_0_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(oldCommitment_0_nullifier);
	const oldCommitment_1_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(oldCommitment_1_nullifier);
